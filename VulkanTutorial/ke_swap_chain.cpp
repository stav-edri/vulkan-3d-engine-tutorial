...
KeSwapChain::KeSwapChain(KeDevice &deviceRef, VkExtent2D extent)
    : device{deviceRef}, windowExtent{extent} {
    init();
}

KeSwapChain::KeSwapChain(KeDevice& deviceRef, VkExtent2D extent, std::shared_ptr<KeSwapChain> previous) :
    device{ deviceRef }, windowExtent{ extent }, oldSwapChain{ previous }
{
    init();
    // cleanup up old swap chain since it's no longer needed
...
VkResult KeSwapChain::submitCommandBuffers(
...
VkSurfaceFormatKHR KeSwapChain::chooseSwapSurfaceFormat(
...
VkPresentModeKHR KeSwapChain::chooseSwapPresentMode(
